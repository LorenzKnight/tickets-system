...
<div class="head" id="head">
    ...
    <div class="config_m">
        <ul>
            ...
            { ?>
                <li><a href="index.php" style="text-align:right; margin-right:20px;">Log in</a></li>
            <?php } ?>
        </ul>
    </div>
</div>
...
<div class="head_fijo" id="head_fijo">
    <div class="logo">
        <img src="../img/sys/ticketsgenerator.svg" alt="" height="60%">
    </div>
    <div class="head_space">
    </div>
    <div class="config_m">
